# Choks Interview — Strategy & Preparation
...
> "Before we get started — I believe you know Sanjay Venkateshamurthy. He's been a mutual connection of ours for a while — small world in the P&C delivery space. He had great things to say about ValueMomentum and encouraged me to explore this opportunity."
...
>
> My engineering background is broad and intentional: full-stack development, cloud-native on AWS and Azure, mobile across Android and iOS, integration via MuleSoft, document composition via SmartCOMM, data pipelines with Snowflake and dbt, RAG architectures using LangChain and Azure OpenAI, and proof-of-concept blockchain work. I write Gosu when the engagement calls for it.
>
> Where this comes together: at EY I held dual AI Advisor roles — for the Insurance practice and the Quality Engineering practice — both involving real production use cases with measurable outcomes. Insurance carriers are at an inflection point on AI adoption, and delivery leaders who can bridge Guidewire implementation depth with AI architecture capability are genuinely rare. That's why I invest in certifications — AWS Solutions Architect, Azure AI Fundamentals, Google GAIL, GitHub Copilot, agentic AI — and it's why I mentor my teams the same way. I'm building practitioners who can deliver AI-enabled insurance solutions, not just advise on them. That combination of hands-on AI delivery and team development is what makes the AI Advisor role increasingly critical — and it's what I want to bring to ValueMomentum."
